...
| `invest-sotp` | ownership-adjusted aggregation and company-level balance-sheet adjustments | segment forecasting |
...
| `invest-framework` | dependency resolution, execution state and bundle validation | leaf formulas or duplicated research |
