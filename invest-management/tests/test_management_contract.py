...
def draft() -> dict:
    ...
    source = {
        ...
        "publisher": "Regulator",
        "url": "https://www.sec.gov/Archives/enforcement.htm",
        "published_date": "2026-01-10",
        "page_or_section": "Outcome",
    ...
    capture = {
        ...
        "tool_call_id": "fixture-regulator",
    ...
    return {
        ...
        "data": {
            ...
            "facts": [
                {
                    ...
                    "claim_ids": ["claim_event"],
                }
            ],
            "interpretations": [
                {
                    "interpretation_id": "integrity_risk",
                    "statement": "The event raises disclosure-control questions.",
                    "fact_ids": ["event_1"],
                    "contrary_fact_ids": [],
                    "confidence": "medium",
                }
            ...
            "red_flag_interpretation_ids": ["integrity_risk"],
...
class ManagementContractTests(unittest.TestCase):
    ...
    def test_interpretation_cannot_reference_unknown_fact(self) -> None:
        ...
        with self.assertRaisesRegex(
            InvestmentArtifactError, "unknown interpretation fact"
        ):
            finalize_draft(value)
    ...
    def test_execution_assessment_reuses_revenue_driver_and_checked_fact(self) -> None:
        ...
        self.assertEqual(
            artifact["data"]["execution_driver_assessments"][0]["status"], "on_track"
        )
    ...
    def test_execution_assessment_cannot_invent_growth_driver(self) -> None:
        ...
        value["data"]["execution_driver_assessments"] = [
            {
                "assessment_id": "execution_1",
                "growth_driver_ids": ["invented_driver"],
                "management_target_ids": [],
                "input_fact_ids": ["event_1"],
                "contrary_fact_ids": [],
                "status": "on_track",
        ...
        with self.assertRaisesRegex(
            InvestmentArtifactError, "unknown execution growth driver"
        ):
            finalize_draft(value)
